...
public:
	...
	BOOL		isPlayerAdmin[ MAX_PLAYERS ];			// + 0x4074
	uint32_t	playersVirtualWorlds[MAX_PLAYERS];		// + 0x4844 - 18500
	BOOL		isPlayerNPC[ MAX_PLAYERS ];				// + 0x5014				// Ouais je sais IsPlayerNPC c'est un peu contradictoire comme nom, mais si vous avez mieux ... gardez le pour vous :p
