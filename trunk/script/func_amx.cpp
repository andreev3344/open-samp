...
cell ( __cdecl* _funcTextDrawCreate )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawCreate;
cell ( __cdecl* _funcTextDrawSetString )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawSetString;
cell ( __cdecl* _funcTextDrawLetterSize )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawLetterSize;
cell ( __cdecl* _funcTextDrawTextSize )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawTextSize;
cell ( __cdecl* _funcTextDrawAlignment )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawAlignment;
cell ( __cdecl* _funcTextDrawColor )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawColor;
cell ( __cdecl* _funcTextDrawUseBox )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawUseBox;
cell ( __cdecl* _funcTextDrawBoxColor )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawBoxColor;
cell ( __cdecl* _funcTextDrawSetShadow )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawSetShadow;
cell ( __cdecl* _funcTextDrawSetOutline )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawSetOutline;
cell ( __cdecl* _funcTextDrawBackgroundColor )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawBackgroundColor;
cell ( __cdecl* _funcTextDrawFont )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawFont;
cell ( __cdecl* _funcTextDrawSetProportional )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawSetProportional;
cell ( __cdecl* _funcTextDrawShowForPlayer )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawShowForPlayer;
cell ( __cdecl* _funcTextDrawShowForAll )( AMX* a_AmxInterface, cell* a_Params ) = ( cell ( __cdecl* )( AMX*, cell* ) )FUNC_TextDrawShowForAll;
...
cell AMX_NATIVE_CALL funcTextDrawBackgroundColor ( AMX* a_AmxInterface, cell* a_Params )
{
	...
	return _funcTextDrawBackgroundColor ( a_AmxInterface, a_Params );
}
cell AMX_NATIVE_CALL funcTextDrawFont ( AMX* a_AmxInterface, cell* a_Params )
{
	logprintf ( "[Call]-> funcTextDrawFont()" );
	return _funcTextDrawFont ( a_AmxInterface, a_Params );
}
