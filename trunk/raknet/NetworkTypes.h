...
struct PlayerID
{
	...
	RAK_DLL_EXPORT PlayerID& operator = ( const PlayerID& input )
	{
	...
	friend RAK_DLL_EXPORT int operator==( const PlayerID& left, const PlayerID& right );
	friend RAK_DLL_EXPORT int operator!=( const PlayerID& left, const PlayerID& right );
	friend RAK_DLL_EXPORT int operator > ( const PlayerID& left, const PlayerID& right );
	friend RAK_DLL_EXPORT int operator < ( const PlayerID& left, const PlayerID& right );
};
...
struct ObjectID
{
	// Set this to true to use peer to peer mode for ObjectIDs.
	// Obviously the value of this must match on all systems.
	// True, and this will write the playerId portion with network sends.  Takes more bandwidth, but ObjectIDs can be locally generated
	...
	RAK_DLL_EXPORT ObjectID& operator = ( const ObjectID& input )
	{
	...
	friend RAK_DLL_EXPORT int operator==( const ObjectID& left, const ObjectID& right );
	friend RAK_DLL_EXPORT int operator!=( const ObjectID& left, const ObjectID& right );
	friend RAK_DLL_EXPORT int operator > ( const ObjectID& left, const ObjectID& right );
	friend RAK_DLL_EXPORT int operator < ( const ObjectID& left, const ObjectID& right );
};
