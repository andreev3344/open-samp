...
GameGetObject_t GameGetObject	= (GameGetObject_t)0x4BFF80;	// Offset for GetObjectPointer function in v1.0.
GameGetVehicle_t GameGetVehicle = (GameGetVehicle_t)0x4BFFC0;	// Offset for GetVehiclePointer function in v1.0.
GameGetActor_t GameGetActor		= (GameGetActor_t)0x4C0000;		// Offset for GetActorPointer function in v1.0.
